...
export const Hero = () => {
	return (
		<div className="relative flex flex-col-reverse py-16 lg:h-75 lg:pt-0 lg:flex-col lg:pb-0">
			...
			>
				<div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
					<div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
						...
						<h2 className="mb-5 font-sans text-4xl font-bold tracking-tight text-gray-900 lg:text-4xl md:text-4x sm:text-4xl sm:leading-none">
							{/* Byron Lewis{" "} */}
